...
final $typed_data.Uint8List tokenListDescriptor = $convert.base64Decode(
    'CglUb2tlbkxpc3QSMgoGdG9rZW5zGAEgAygLMhouemVsbGltc2VydmVyLnYxLlRva2VuSW5mb1'
    'IGdG9rZW5z');
...
final $typed_data.Uint8List clientFrameDescriptor = $convert.base64Decode(
    'CgtDbGllbnRGcmFtZRI0CgZhdHRhY2gYASABKAsyGi56ZWxsaW1zZXJ2ZXIudjEuQXR0YWNoUm'
    'VxSABSBmF0dGFjaBIWCgVpbnB1dBgCIAEoDEgAUgVpbnB1dBIxCgZyZXNpemUYAyABKAsyFy56'
    'ZWxsaW1zZXJ2ZXIudjEuUmVzaXplSABSBnJlc2l6ZUIGCgRraW5k');
...
const ServerFrame$json = {
  ...
  '2': [
    {'1': 'render', '3': 1, '4': 1, '5': 12, '9': 0, '10': 'render'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.zellimserver.v1.ControlEvent',
      '9': 0,
      '10': 'control'
    },
  ],
...
final $typed_data.Uint8List serverFrameDescriptor = $convert.base64Decode(
    'CgtTZXJ2ZXJGcmFtZRIYCgZyZW5kZXIYASABKAxIAFIGcmVuZGVyEjkKB2NvbnRyb2wYAiABKA'
    'syHS56ZWxsaW1zZXJ2ZXIudjEuQ29udHJvbEV2ZW50SABSB2NvbnRyb2xCBgoEa2luZA==');
...
final $typed_data.Uint8List sessionListDescriptor = $convert.base64Decode(
    'CgtTZXNzaW9uTGlzdBI4CghzZXNzaW9ucxgBIAMoCzIcLnplbGxpbXNlcnZlci52MS5TZXNzaW'
    '9uSW5mb1IIc2Vzc2lvbnM=');
...
final $typed_data.Uint8List layoutDescriptor = $convert.base64Decode(
    'CgZMYXlvdXQSKwoEdGFicxgBIAMoCzIXLnplbGxpbXNlcnZlci52MS5UYWJNc2dSBHRhYnM=');
...
final $typed_data.Uint8List tabMsgDescriptor = $convert.base64Decode(
    ...
    'IuCgVwYW5lcxgHIAMoCzIYLnplbGxpbXNlcnZlci52MS5QYW5lTXNnUgVwYW5lcxIrChFmdWxs'
    'c2NyZWVuX2FjdGl2ZRgIIAEoCFIQZnVsbHNjcmVlbkFjdGl2ZRI0ChZmbG9hdGluZ19wYW5lc1'
    '92aXNpYmxlGAkgASgIUhRmbG9hdGluZ1BhbmVzVmlzaWJsZQ==');
...
final $typed_data.Uint8List toggleFullscreenReqDescriptor = $convert.base64Decode(
    'ChNUb2dnbGVGdWxsc2NyZWVuUmVxEjMKBnRhcmdldBgBIAEoCzIbLnplbGxpbXNlcnZlci52MS'
    '5QYW5lVGFyZ2V0UgZ0YXJnZXQSLAoSdGFyZ2V0X2lzX2Zsb2F0aW5nGAIgASgIUhB0YXJnZXRJ'
    'c0Zsb2F0aW5nEikKEGZsb2F0aW5nX3Zpc2libGUYAyABKAhSD2Zsb2F0aW5nVmlzaWJsZRI7Ch'
    'p0YXJnZXRfaXNfZm9jdXNlZF9mbG9hdGluZxgEIAEoCFIXdGFyZ2V0SXNGb2N1c2VkRmxvYXRp'
    'bmcSKgoRaGFzX2Zsb2F0aW5nX2hpbnQYBSABKAhSD2hhc0Zsb2F0aW5nSGludA==');
...
final $typed_data.Uint8List writeToPaneReqDescriptor = $convert.base64Decode(
    'Cg5Xcml0ZVRvUGFuZVJlcRIzCgZ0YXJnZXQYASABKAsyGy56ZWxsaW1zZXJ2ZXIudjEuUGFuZV'
    'RhcmdldFIGdGFyZ2V0EhIKBGRhdGEYAiABKAxSBGRhdGE=');
...
final $typed_data.Uint8List renamePaneReqDescriptor = $convert.base64Decode(
    'Cg1SZW5hbWVQYW5lUmVxEjMKBnRhcmdldBgBIAEoCzIbLnplbGxpbXNlcnZlci52MS5QYW5lVG'
    'FyZ2V0UgZ0YXJnZXQSEgoEbmFtZRgCIAEoCVIEbmFtZQ==');
...
const ResizePaneReq$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.zellimserver.v1.ResizeDirection',
      '10': 'direction'
    },
  ],
};
...
final $typed_data.Uint8List resizePaneReqDescriptor = $convert.base64Decode(
    'Cg1SZXNpemVQYW5lUmVxEjMKBnRhcmdldBgBIAEoCzIbLnplbGxpbXNlcnZlci52MS5QYW5lVG'
    'FyZ2V0UgZ0YXJnZXQSMwoGcmVzaXplGAIgASgOMhsuemVsbGltc2VydmVyLnYxLlJlc2l6ZUtp'
    'bmRSBnJlc2l6ZRI+CglkaXJlY3Rpb24YAyABKA4yIC56ZWxsaW1zZXJ2ZXIudjEuUmVzaXplRG'
    'lyZWN0aW9uUglkaXJlY3Rpb24=');
...
const ScrollReq$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.zellimserver.v1.ScrollDirection',
      '10': 'direction'
    },
  ],
};
...
final $typed_data.Uint8List scrollReqDescriptor = $convert.base64Decode(
    'CglTY3JvbGxSZXESMwoGdGFyZ2V0GAEgASgLMhsuemVsbGltc2VydmVyLnYxLlBhbmVUYXJnZX'
    'RSBnRhcmdldBI+CglkaXJlY3Rpb24YAiABKA4yIC56ZWxsaW1zZXJ2ZXIudjEuU2Nyb2xsRGly'
