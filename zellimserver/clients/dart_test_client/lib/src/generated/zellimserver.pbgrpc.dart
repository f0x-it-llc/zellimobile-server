...
import 'zellimserver.pb.dart' as $0;

export 'zellimserver.pb.dart';
...
@$pb.GrpcServiceName('zellimserver.v1.Zelli')
class ZelliClient extends $grpc.Client {
  ...
  ZelliClient(super.channel, {super.options, super.interceptors});
  ...
  static final _$listTokens = $grpc.ClientMethod<$0.Empty, $0.TokenList>(
      '/zellimserver.v1.Zelli/ListTokens',
      ($0.Empty value) => value.writeToBuffer(),
      $0.TokenList.fromBuffer);
  static final _$revokeToken =
      $grpc.ClientMethod<$0.RevokeTokenReq, $0.ActionAck>(
          '/zellimserver.v1.Zelli/RevokeToken',
          ($0.RevokeTokenReq value) => value.writeToBuffer(),
          $0.ActionAck.fromBuffer);
}

@$pb.GrpcServiceName('zellimserver.v1.Zelli')
abstract class ZelliServiceBase extends $grpc.Service {
  $core.String get $name => 'zellimserver.v1.Zelli';
