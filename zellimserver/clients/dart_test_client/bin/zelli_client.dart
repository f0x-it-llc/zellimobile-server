/// zelli_client.dart — End-to-end gRPC test client for zellimserver.
///
...
import 'package:zelli_client/src/generated/zellimserver.pbgrpc.dart';
...
Future<void> main(List<String> argv) async {
  ...
  if (args['help'] as bool) {
    print('Usage: dart run bin/zelli_client.dart --token <UUID> [options]\n');
    print(parser.usage);
    exit(0);
  }
  ...
  print('=== zellimserver gRPC test client ===');
  ...
  try {
    ...
    heading('GetVersion');
    final unauthStub = ZelliClient(channel);
    try {
...
Future<void> _runAttachTerminal(ZelliClient stub, String session) async {
...
Future<void> _runNewTabTest(ZelliClient stub, String session) async {
