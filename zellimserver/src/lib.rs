...
//! - `grpc`    — tonic Zelli service implementation (GetVersion, Login, AttachTerminal, ListSessions, GetLayout)
...
/// Generated protobuf + tonic types for `zellimserver.v1`.
///
/// Included from the `$OUT_DIR` path produced by `tonic-prost-build` in
/// `build.rs`.
pub mod proto {
    tonic::include_proto!("zellimserver.v1");
}
