...
async fn build_authed(
    ...
    let mut bootstrap = ZelliClient::new(channel.clone());
    let resp = bootstrap
        .login(LoginRequest {
    ...
    Ok(ZelliClient::with_interceptor(channel, interceptor))
}
