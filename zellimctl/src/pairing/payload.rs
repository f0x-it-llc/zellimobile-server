...
//!
//! ```text
//! zellimobile://pair?v=2&h=<host>&p=<port>&t=<base64url>&ro=<0|1>&n=<pct-encoded>&tm=<pin|ca>[&fp=<hex>]
//! ```
//!
...
impl PairingParams {
    /// Build the `zellimobile://pair?...` URI (v=2).
    ///
    ...
    pub fn to_uri(&self) -> String {
        ...
        format!(
            "zellimobile://pair?v=2&h={h}&p={p}&t={t}&ro={ro}&n={n}&{trust}",
            h = self.host,
            p = self.port,
            t = token_b64,
            ro = ro,
