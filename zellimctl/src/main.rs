//! zellimctl — install / configure / pair TUI for zellimserver.
//!
//! A standalone ratatui control panel that drives zellimserver's library + CLI
...
fn main() -> Result<()> {
    ...
    // default; raise with e.g. `RUST_LOG=zellimctl=debug`.
